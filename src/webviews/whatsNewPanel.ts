...
export class WhatsNewPanel {
    ...
    public static readonly LATEST_ANNOUNCEMENT_ID = 'feb-2026-v0.5.5';
        ...
        <head>
            ...
            <style>
                ...
                *, *::before, *::after {
                ...
                .feature-item.fi-7 { animation: slideInFromRight 0.5s ease-out 0.7s both; }
                        ...
                        <div class="header-content">
                            ...
                            <div class="header-text">
                                <h1>
                                    ...
                                    <span class="version-badge">v0.5.5</span>
                                </h1>
                            ...
                            <div class="section-content">
                                <div class="feature-item fi-0">
                                    ...
                                    <div class="feature-text">
                                        <h4>Automatic Tenant Detection</h4>
                                        <p>Intelligent multi-tenant authentication with auto-discovery - shows tenant picker with friendly names instead of manual GUID entry</p>
                                    </div>
                                ...
                                <div class="feature-item fi-3">
                                    <div class="feature-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.875A1.125 1.125 0 0113.125 7.125v-1.875a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                                        </svg>
                                    </div>
                                    <div class="feature-text">
                                        <h4>Full YAML Path Display</h4>
                                        <p>Pipeline editor and Run Pipeline panel now show the complete repo/path (e.g. my-repo / .azure-pipelines/pipeline.yml)</p>
                                    </div>
                                    <div class="hover-dot"><div class="hover-dot-inner"></div></div>
                                </div>
                            </div>
